...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net DoCompute_1_m_axi_INPUT_r [get_bd_intf_pins DoCompute_1/m_axi_INPUT_r] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net DoCompute_1_m_axi_OUTPUT_r [get_bd_intf_pins DoCompute_1/m_axi_OUTPUT_r] [get_bd_intf_pins smartconnect_1/S01_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins DoCompute_0/ap_clk] [get_bd_pins DoCompute_1/ap_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins DoCompute_0/ap_rst_n] [get_bd_pins DoCompute_1/ap_rst_n] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x80000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DoCompute_0/s_axi_AXILiteS/Reg] SEG_DoCompute_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DoCompute_1/s_axi_AXILiteS/Reg] SEG_DoCompute_1_Reg
